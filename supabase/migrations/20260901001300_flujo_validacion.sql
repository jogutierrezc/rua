...
-- real tiene varias firmas: se valida el impacto presupuestal, auditoría da el
-- visto bueno normativo, y finalmente la administración crea la actividad.
--
...
--
-- NOTA: la migración 14 corrige la composición de la cadena (Coordinación
-- Académica solicita, no firma) y añade la etapa que materializa el cambio.
-- =============================================================================
...
--
-- La migración 14 la redefine para añadir la materialización del cambio.
-- -----------------------------------------------------------------------------
...
--
-- La migración 14 le añade la columna `materializa` al final.
-- -----------------------------------------------------------------------------
